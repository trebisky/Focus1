Back in 2013 or so, I cloned this from: 

        https://github.com/omcaree/node-pru

I have not looked since to see what work has been done since.
I hacked on it some, adding some functionality, so I am preserving
exactly what is working for me.   Once again, these needs to be
revisited and looked at circa 2020.   Tom Trebisky

The original README follows and is quite informative.
